...
impl ToString for HapType {
    fn to_string(&self) -> String {
        match self {
			...
			HapType::MatterFirmwareRevisionNumber => "26D".into(),
			HapType::MatterFirmwareUpdateStatus => "26E".into(),
			HapType::MaximumTransmitPower => "243".into(),
			HapType::MetricsBufferFullState => "272".into(),
			...
			HapType::SelectedSleepConfiguration => "252".into(),
			...
			HapType::FirmwareUpdate => "236".into(),
			...
			HapType::TapManagement => "22E".into(),
...
impl FromStr for HapType {
    ...
    fn from_str(s: &str) -> Result<Self, Self::Err> {
        ...
        match s {
			...
			"26D" => Ok(HapType::MatterFirmwareRevisionNumber),
			"26E" => Ok(HapType::MatterFirmwareUpdateStatus),
			"243" => Ok(HapType::MaximumTransmitPower),
			"272" => Ok(HapType::MetricsBufferFullState),
			"21" => Ok(HapType::Model),
			...
			"252" => Ok(HapType::SelectedSleepConfiguration),
