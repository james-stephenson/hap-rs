...
/// Selected Sleep Configuration characteristic.
#[derive(Debug, Default, Serialize)]
pub struct SelectedSleepConfigurationCharacteristic(Characteristic<Vec<u8>>);

impl SelectedSleepConfigurationCharacteristic {
    /// Creates a new Selected Sleep Configuration characteristic.
    pub fn new(id: u64, accessory_id: u64) -> Self {
        #[allow(unused_mut)]
        let mut c = Self(Characteristic::<Vec<u8>> {
            id,
            accessory_id,
            hap_type: HapType::SelectedSleepConfiguration,
            format: Format::Tlv8,
            perms: vec![
				Perm::Events,
				Perm::PairedRead,
...
#[async_trait]
impl HapCharacteristic for SelectedSleepConfigurationCharacteristic {
...
impl HapCharacteristicSetup for SelectedSleepConfigurationCharacteristic {
...
impl CharacteristicCallbacks<Vec<u8>> for SelectedSleepConfigurationCharacteristic {
...
impl AsyncCharacteristicCallbacks<Vec<u8>> for SelectedSleepConfigurationCharacteristic {
