...
/// Matter Firmware Revision Number characteristic.
#[derive(Debug, Default, Serialize)]
pub struct MatterFirmwareRevisionNumberCharacteristic(Characteristic<u32>);

impl MatterFirmwareRevisionNumberCharacteristic {
    /// Creates a new Matter Firmware Revision Number characteristic.
    pub fn new(id: u64, accessory_id: u64) -> Self {
        #[allow(unused_mut)]
        let mut c = Self(Characteristic::<u32> {
            id,
            accessory_id,
            hap_type: HapType::MatterFirmwareRevisionNumber,
...
#[async_trait]
impl HapCharacteristic for MatterFirmwareRevisionNumberCharacteristic {
...
impl HapCharacteristicSetup for MatterFirmwareRevisionNumberCharacteristic {
...
impl CharacteristicCallbacks<u32> for MatterFirmwareRevisionNumberCharacteristic {
...
impl AsyncCharacteristicCallbacks<u32> for MatterFirmwareRevisionNumberCharacteristic {
