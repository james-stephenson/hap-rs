...
/// Supported Sleep Configuration characteristic.
#[derive(Debug, Default, Serialize)]
pub struct SupportedSleepConfigurationCharacteristic(Characteristic<Vec<u8>>);

impl SupportedSleepConfigurationCharacteristic {
    /// Creates a new Supported Sleep Configuration characteristic.
    pub fn new(id: u64, accessory_id: u64) -> Self {
        #[allow(unused_mut)]
        let mut c = Self(Characteristic::<Vec<u8>> {
            id,
            accessory_id,
            hap_type: HapType::SupportedSleepConfiguration,
            format: Format::Tlv8,
            perms: vec![
				Perm::PairedRead,
            ],
...
#[async_trait]
impl HapCharacteristic for SupportedSleepConfigurationCharacteristic {
...
impl HapCharacteristicSetup for SupportedSleepConfigurationCharacteristic {
...
impl CharacteristicCallbacks<Vec<u8>> for SupportedSleepConfigurationCharacteristic {
...
impl AsyncCharacteristicCallbacks<Vec<u8>> for SupportedSleepConfigurationCharacteristic {
