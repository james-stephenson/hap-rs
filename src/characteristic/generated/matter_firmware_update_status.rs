...
/// Matter Firmware Update Status characteristic.
#[derive(Debug, Default, Serialize)]
pub struct MatterFirmwareUpdateStatusCharacteristic(Characteristic<Vec<u8>>);

impl MatterFirmwareUpdateStatusCharacteristic {
    /// Creates a new Matter Firmware Update Status characteristic.
    pub fn new(id: u64, accessory_id: u64) -> Self {
        #[allow(unused_mut)]
        let mut c = Self(Characteristic::<Vec<u8>> {
            id,
            accessory_id,
            hap_type: HapType::MatterFirmwareUpdateStatus,
            format: Format::Tlv8,
            perms: vec![
				Perm::Events,
				Perm::PairedRead,
...
#[async_trait]
impl HapCharacteristic for MatterFirmwareUpdateStatusCharacteristic {
...
impl HapCharacteristicSetup for MatterFirmwareUpdateStatusCharacteristic {
...
impl CharacteristicCallbacks<Vec<u8>> for MatterFirmwareUpdateStatusCharacteristic {
...
impl AsyncCharacteristicCallbacks<Vec<u8>> for MatterFirmwareUpdateStatusCharacteristic {
